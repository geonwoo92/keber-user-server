select *from boards;
--
-- insert into boards (id, title,description, reg_date, mod_date) values(1, "review","content", now(), now());
-- insert into boards (id, title,description, reg_date, mod_date) values(2, "qna","contnent", now(), now());
-- insert into users (id, username, password, name, phone, job , reg_date, mod_date) values (1, 'Clarinda', 'Boiler@1maker', 'Chrissie', '230-644-4753', 'Professor', now(), now());
-- insert into users (id, username, password, name, phone, job , reg_date, mod_date) values (2, 'Culion Island', 'Ir#1onworker', 'Fannie', '372-654-5644', 'Analog Circuit Design manager', now(), now());
-- insert into users (id, username, password, name, phone, job , reg_date, mod_date) values (3, 'Houma', 'Ironwo@4rker', 'Zaria', '921-901-6334', 'Media Manager II', now(), now());
-- insert into users (id, username, password, name, phone, job , reg_date, mod_date) values (4, 'Recife', 'Tile@Set3ter', 'Alisun', '868-948-4104', 'Budget/Accounting Analyst I', now(), now());
-- insert into users (id, username, password, name, phone, job , reg_date, mod_date) values (5, 'Sege', 'Plaster@1ers', 'Pennie', '940-551-8764', 'Financial Analyst', now(), now());
-- insert into users (id, username, password, name, phone, job , reg_date, mod_date) values (6, 'Nacala', 'Mil@lwri3ght', 'Gertruda', '517-268-7651', 'VP Marketing', now(), now());
-- insert into users (id, username, password, name, phone, job , reg_date, mod_date) values (7, 'Tobermorey', 'Safety@Of1ficer', 'Harli', '136-238-7702', 'VP Sales', now(), now());
-- insert into users (id, username, password, name, phone, job , reg_date, mod_date) values (8, 'Mende/Brénoux', 'H@VA4C', 'Rosalia', '524-152-5660', 'Help Desk Technician', now(), now());
-- insert into users (id, username, password, name, phone, job , reg_date, mod_date) values (9, 'Bouarfa', 'Refrid@ger1ation', 'Eugenie', '913-369-7000', 'Executive Secretary', now(), now());
-- insert into users (id, username, password, name, phone, job , reg_date, mod_date) values (10, 'Bucharest', 'Sh1@eetM1e@tal Worker', 'Nina', '688-278-3563', 'Payment Adjustment Coordinator', now(), now());
-- insert into users (id, username, password, name, phone, job , reg_date, mod_date) values (11, 'Kepi-Papua Island', 'Til@e1Setter', 'Ashley', '595-588-1044', 'Geologist III', now(), now());
-- insert into users (id, username, password, name, phone, job , reg_date, mod_date) values (12, 'Cairo', 'Wate@r3proofer', 'Antonia', '202-338-4567', 'Tax Accountant', now(), now());
-- insert into users (id, username, password, name, phone, job , reg_date, mod_date) values (13, 'Butare', 'Plas@ter1ers', 'Martita', '978-322-8638', 'Engineer I', now(), now());
-- insert into users (id, username, password, name, phone, job , reg_date, mod_date) values (14, 'Buenaventura', 'We@ld1er', 'Min', '472-388-3046', 'Human Resources Assistant II', now(), now());
-- insert into users (id, username, password, name, phone, job , reg_date, mod_date) values (15, 'opera', 'Equipmen3t@Operator', 'Antonie', '658-863-0908', 'Physical Therapy Assistant', now(), now());
